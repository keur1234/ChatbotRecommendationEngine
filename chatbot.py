...
class RecommendationChatbot:
    ...
    # Stores chat history to a CSV file like a temporary database
    ...
    def generate_response(self, message):
        ...
        หากไม่พบสินค้าหรือบริการ ให้ตอบว่า ขอโทษค่ะ ตอนนี้ทางร้านยังไม่มีสินค้าที่ต้องการ
        ...
        ใช้ "assistant" เป็นข้อมูลสินค้าที่ Query มา ใช้ก็ต่อเมื่อจะแนะนำสินค้าหรือลูกค้าถามลาละเอียดเกี่ยวกับสินค้า
